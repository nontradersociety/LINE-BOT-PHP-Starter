    ...
    foreach ($events['events'] as $event) {
		...
		if ( strpos($textinput, 'ป้าเย') !== false || strpos($textinput, 'เยเลน') !== false || strpos($textinput, 'yellen') !== false || strpos($textinput, 'Yellen') !== false ) {
            ...
            if ( strpos($textinput, 'หิว') !== false ) {
                $rand = rand(0, 15);
                if ($rand == 0) {
                    $img = 'https://scontent.fbkk25-1.fna.fbcdn.net/v/t1.0-9/149133136_3985735971445400_869250586854532532_o.jpg?_nc_cat=110&ccb=3&_nc_sid=0debeb&_nc_eui2=AeG7XW0DG2towNjCuixpZltSMjRAkP12uqgyNECQ_Xa6qOgIYJbIcl4lH7BgruE5hBbXBaObz9tvwU1j6yxEmrrI&_nc_ohc=DHZwSHKmdm0AX-uNXbl&_nc_ht=scontent.fbkk25-1.fna&oh=330c6800564a362bc99dfdd4a9e1f5d0&oe=604AEEEA';
                } elseif ($rand == 1) {
                    $img = 'https://scontent.fbkk25-1.fna.fbcdn.net/v/t1.0-9/144199939_3967306969954967_4893989307713755501_o.jpg?_nc_cat=110&ccb=3&_nc_sid=8bfeb9&_nc_eui2=AeELGbi1D1iGUqIQbJFtCAACNxhNqnSMbkE3GE2qdIxuQeJOYVClJ4JRea-lLTy_sqb9XCmNXc5vwlacQmkEk7bo&_nc_ohc=N91RG4djkUYAX8uxyw7&_nc_ht=scontent.fbkk25-1.fna&oh=9bc178c1da95008e1e5f5ba6d22a11b6&oe=604CC560';
                } elseif ($rand == 2) {
                    $img = 'https://scontent.fbkk25-1.fna.fbcdn.net/v/t1.0-9/142471295_3952500638102267_8701153823994772913_o.jpg?_nc_cat=103&ccb=3&_nc_sid=0debeb&_nc_eui2=AeE73ncvGBMu5nsALDWqCUeOaInCgL9ruSJoicKAv2u5IlB0SAJ7bvOmXeZbwYw2j8JsRNZP3PsWZmuzua2k8QSf&_nc_ohc=XEjn1Y6jH7cAX_rmMCP&_nc_ht=scontent.fbkk25-1.fna&oh=0b23f4c797a940b3cd73d8d3f1ae31e8&oe=604AD831';
                } elseif ($rand == 3) {
                    $img = 'https://scontent.fbkk25-1.fna.fbcdn.net/v/t1.0-9/141849032_3943923425626655_964946017425739865_o.jpg?_nc_cat=107&ccb=3&_nc_sid=0debeb&_nc_eui2=AeEpQp0s1xCPZ-b-h-X4KDzbWMuQndyt1xtYy5Cd3K3XG7b8Vf1cJo3aULhTT8p94qJvtcKy5ypVhqIfuTFyxJaW&_nc_ohc=T30cyjchIF4AX8wl05c&_nc_ht=scontent.fbkk25-1.fna&oh=17c2bd16017f2d373dfde2991f4f70b5&oe=604C4D2F';
                } elseif ($rand == 4) {
                    $img = 'https://scontent.fbkk25-1.fna.fbcdn.net/v/t1.0-9/139672381_3928684130483918_6948451488250836660_o.jpg?_nc_cat=107&ccb=3&_nc_sid=0debeb&_nc_eui2=AeHMlsU_6DakbwKzFQZVN7OvSuF3e6ZSzeZK4Xd7plLN5twXaQqNs2iE67JjqV5nR138yuYC9FEp1qWzdRyiDFRq&_nc_ohc=hIKvSI8N2z4AX9ECiOM&_nc_ht=scontent.fbkk25-1.fna&oh=d07b05e87e0b12af1ced81662adc76b2&oe=604C4FB6';
                } elseif ($rand == 5) {
                    $img = 'https://scontent.fbkk25-1.fna.fbcdn.net/v/t1.0-9/130911414_3820312067987792_2553292204799265491_o.jpg?_nc_cat=100&ccb=3&_nc_sid=0debeb&_nc_eui2=AeFSFB9PlEjVx1ypHZxbB5iG5COohKE4b9PkI6iEoThv04dTF8b_tdh1SJMNZLRjb6YuNq_RWAPnqBp7wcOQYVwz&_nc_ohc=23YDRh8Fh-wAX90Ypfs&_nc_oc=AQlz2UYHGfiNMRODkI8ZyacdjosttkKA0dWHtrRTgZiTBofODMkcyz2zUoBl3tkUzlHOoC-ACNP7Y3z9wcKSD_MP&_nc_ht=scontent.fbkk25-1.fna&oh=b684ea957ea3a788d878b6e6f16be895&oe=604D5A17';
                } elseif ($rand == 6) {
                    $img = 'https://scontent.fbkk25-1.fna.fbcdn.net/v/t1.0-9/129901871_3820311631321169_582832000698030433_o.jpg?_nc_cat=104&ccb=3&_nc_sid=0debeb&_nc_eui2=AeH13AEhhAAEEKeHuAXI9c0wB210vJNhKFgHbXS8k2EoWOcNnqCAL-yU-f_kxHjMN__l4h8h1s-cedDazQ9ziM9-&_nc_ohc=ghWejaeejnQAX9F12pw&_nc_ht=scontent.fbkk25-1.fna&oh=aad4f89343d78d4d74ff0b1a4ba85fc0&oe=604CDB9B';
                } elseif ($rand == 7) {
                    $img = 'https://scontent.fbkk25-1.fna.fbcdn.net/v/t1.0-9/125951278_3770881149597551_6954342129730761893_o.jpg?_nc_cat=104&ccb=3&_nc_sid=0debeb&_nc_eui2=AeG2mT4cq5O4kEaVXhU4LbIad1-j9B7qcW13X6P0Hupxbfy3Vv0WxeYfiuhSSmGwxojfjYlbMSZf3lNkC3PjgUG0&_nc_ohc=5-wjCqoz07cAX9dKf_9&_nc_ht=scontent.fbkk25-1.fna&oh=eeaedde6e216c63c6397bfb46edd9e29&oe=604D80DC';
                } elseif ($rand == 8) {
                    $img = 'https://scontent.fbkk25-1.fna.fbcdn.net/v/t1.0-9/120956718_3653764477975886_381147732628745111_o.jpg?_nc_cat=106&ccb=3&_nc_sid=0debeb&_nc_eui2=AeFmKHkHVl3sIJQRTBarMydoZfMfXvwvW5dl8x9e_C9bl6_mJG75RverIctJ5fNCVdDCS7ORxZXTJJqfRWQJoJ7T&_nc_ohc=H1X0nwH6-BIAX9g6U8P&_nc_ht=scontent.fbkk25-1.fna&oh=b5536c462c4addcb8038282b0ac1359e&oe=604B04DB';
                } elseif ($rand == 9) {
                    $img = 'https://scontent.fbkk25-1.fna.fbcdn.net/v/t1.0-9/103638331_3290968910922113_7378007031680861335_o.jpg?_nc_cat=100&ccb=3&_nc_sid=0debeb&_nc_eui2=AeEQFxxhCIVvo5nsg6-0O312k6syJcCHTjWTqzIlwIdONXr6bY7bfRSEAKcsjUGBDBXufM0NjjGPGUp5Y25CL8NF&_nc_ohc=Tb-BxIlPJmEAX9jQNYX&_nc_ht=scontent.fbkk25-1.fna&oh=c8a385f637a8387cbddf512d4d74ca41&oe=604AE8AE';
                } elseif ($rand == 10) {
                    $img = 'https://scontent.fbkk25-1.fna.fbcdn.net/v/t1.0-9/118286129_3507555572596778_1238682937140286538_o.jpg?_nc_cat=109&ccb=3&_nc_sid=0debeb&_nc_eui2=AeFSVh2qeeSiRnUg4jQtk-7eFEJSXKMvIoYUQlJcoy8ihlwmxOsvDX8vGuEgTXmiSmswkIDC-y-VVtYfY5vWX-ha&_nc_ohc=czfwVgv9hhoAX9Nprar&_nc_ht=scontent.fbkk25-1.fna&oh=7e78bc1954e4bed7d5d7d7662a8d1013&oe=6049BA4E';
                } elseif ($rand == 11) {
                    $img = 'https://scontent.fbkk25-1.fna.fbcdn.net/v/t1.0-9/116698947_3432835093402160_7478592639704383788_o.jpg?_nc_cat=105&ccb=3&_nc_sid=0debeb&_nc_eui2=AeHesZ28vA78De7txmRry0QMyVqGTPB7xB7JWoZM8HvEHgZeYK-_STB9DUTh2qAZCO4YSw6XM1C7IbIDK6msv6r6&_nc_ohc=WygAtAQfshkAX9vvvrD&_nc_ht=scontent.fbkk25-1.fna&oh=ef64df7890645f1659f1012a34091e31&oe=604CA431';
                } elseif ($rand == 12) {
                    $img = 'https://scontent.fbkk25-1.fna.fbcdn.net/v/t1.0-9/122531715_3697043956981271_4132752436715316767_o.jpg?_nc_cat=109&ccb=3&_nc_sid=0debeb&_nc_eui2=AeFCvy8z_xbxa5ftY75XW9bSfn5lhrZX1wN-fmWGtlfXA6CsBLiDtY3chdlFSiYKq7HjsI_u5ukN69WrMYTYllts&_nc_ohc=RAFylDm7rSgAX8c86Cc&_nc_ht=scontent.fbkk25-1.fna&oh=86138b6dd25cc42f7372ae92acb30891&oe=604CE5B1';
                } elseif ($rand == 13) {
                    $img = 'https://scontent.fbkk25-1.fna.fbcdn.net/v/t1.0-9/123144504_3708408092511524_5114494772408810474_o.jpg?_nc_cat=103&ccb=3&_nc_sid=0debeb&_nc_eui2=AeHXMS2b8amRflxJVf_FWW-EIeNmsPmOdXwh42aw-Y51fM9jatfaP4dttZx55wdJsOrJ95kegExhoZyXhPu_cFlm&_nc_ohc=GlD02YWE5rwAX8hry7c&_nc_ht=scontent.fbkk25-1.fna&oh=4c1621a1a358b144c745d7b2e6e2981e&oe=604B2A3E';
                } else {
                    $text = 'กินอะไรกันดีละ';
                    $case = 1;
                }
